...
<img width="70%" class="image" align="middle" src="../images/FunctionalProgramming.jpg" alt="Breakdown of a main function into the smaller functions it uses">
</div>
...
<div style="text-align: center;">
<img width="70%" class="image" align="middle" src="../images/Agile.png" alt="Diagram of the agile project management process">
</div>
